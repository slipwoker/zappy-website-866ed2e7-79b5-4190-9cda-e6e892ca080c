      ...
      if (window.zappyContactFormLoaded) {
        (async function() {
          try {
            ...
            const zappyPayload = {
              websiteId: '866ed2e7-79b5-4190-9cda-e6e892ca080c',
              name: name,
              email: email,
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Капибара uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
